...
export default function CustomerRegisterPage() {
    ...
    async function verifytRegistration() {
        ...
        try {
            ...
            const data =
                await customerAuthService.verifyRegistration({
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-white p-8 ">
            <div className="grid w-full max-w-[1320px] overflow-hidden rounded-[42px] border border-slate-200 bg-white shadow-[0_35px_90px_rgba(15,23,42,0.08)] xl:grid-cols-[1fr_620px] ">
                <div className="hidden xl:flex flex-col justify-between bg-gradient-to-br from-blue-700 via-blue-600 to-slate-900 p-14 text-white ">
                    <div>
                        <h2 className="mt-10 text-6xl font-black leading-[1.15] ">
                            شروع خرید
                            هوشمند صنعتی
                        </h2>
                ...
                <div className=" p-12 xl:p-14 ">
                    ...
                    {step === "form" && (
                        <div className="mt-10 space-y-4">
                            ...
                            <button onClick={registerNewCustomer} disabled={loading} className=" group flex w-full items-center justify-center gap-3 rounded-3xl bg-blue-600 py-5 font-black text-white transition hover:scale-[1.02] ">
                                {
                                    loading
                                        ?
                    ...
                    {step === "otp" && (
                        ...
                        <div className=" mt-10 space-y-6 ">
                            ...
                            <div className="grid gap-4 md:grid-cols-2 ">
                                ...
                                <button onClick={verifytRegistration} disabled={loading} className=" rounded-2xl bg-blue-600 py-4 font-black text-white " >
                                    {
                                        loading
                                            ?
                                            "درحال ثبت..."
...
function Field({ icon, placeholder, type, value, onChange }: any) {
    return (
        <div className=" group flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 px-6 transition focus-within:border-blue-500 focus-within:bg-white ">
            ...
            <input type={type || "text"} placeholder={placeholder} value={value} onChange={(e) => onChange(e.target.value)} className=" w-full bg-transparent py-4 outline-none " />
        </div>
    );
}
