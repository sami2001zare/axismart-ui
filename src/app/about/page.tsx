                    ...
                    <div className="mx-auto max-w-[1450px] px-8">
                        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
                            ...
                            <p className="mt-12 max-w-225 text-xl leading-[2.2] text-slate-600">
                                بلبرینگ پارسا با تمرکز بر تامین تخصصی بلبرینگ، تسمه، پولی و زنجیر
                                صنعتی، زیرساختی حرفه‌ای برای خرید خرده، عمده و پروژه‌ای ایجاد کرده
                                است.
                            </p>
                        </motion.div>
                    </div>
...
function Stat({ number, label }: { number: string; label: string }) {
    return (
        <div className="border border-slate-200 bg-white p-12 text-center">
            <h3 className="text-6xl font-black text-blue-600">{number}</h3>
