...
export default function CustomerLoginPage() {
    ...
    async function loginPassword() {
        ...
        try {
            ...
            if (attempts >= 3) {
                setOtpEnabled(true);
                setError(
                    "۳ بار رمز اشتباه وارد شد. ورود پیامکی فعال شد."
                );
            } else {
                setError(
                    `رمز عبور اشتباه است. (${attempts}/3)`
                );
            }
    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-white p-8 ">
            <div className="grid w-full max-w-[1250px] overflow-hidden rounded-[42px] border border-slate-200 bg-white shadow-[0_30px_90px_rgba(15,23,42,0.08)] xl:grid-cols-[1fr_560px] ">
                ...
                <div className="hidden xl:flex flex-col justify-between bg-gradient-to-br from-blue-700 via-blue-600 to-slate-900 p-14 text-white ">
                    <div>
                        ...
                        <h2 className=" mt-10 text-6xl font-black leading-[1.2] ">
                            پلتفرم
                            فروش صنعتی
                            نسل جدید
                        </h2>
                ...
                <div className=" relative p-12 xl:p-14 ">
                    <div className=" absolute right-[-90px] top-[-90px] h-[220px] w-[220px] rounded-full bg-blue-100 blur-3xl " />
                    <div className={` relative transition-all duration-300 ${shake ? "animate-[shake_0.35s_linear]" : ""} `}>
                        ...
                        {mode === "password" && (
                            <>
                                ...
                                <button
                                    ...
                                    className=" mt-8 group flex w-full items-center justify-center gap-3 rounded-3xl bg-blue-600 py-5 font-black text-white transition-all duration-300 hover:scale-[1.02] hover:bg-blue-700 "
                                >
                                    {loading
                                        ?
                        ...
                        <div className={` overflow-hidden transition-all duration-500 ${otpEnabled ? "max-h-[420px] opacity-100 mt-10" : "max-h-0 opacity-0"} `}>
...
function Field({ icon, placeholder, type, value, onChange }:
    ...
    return (
        <div className=" group flex items-center gap-4 rounded-3xl border border-slate-200 bg-slate-50 px-6 transition duration-300 focus-within:border-blue-500 focus-within:bg-white ">
            ...
            <input type={type || "text"} placeholder={placeholder} value={value} onChange={(e) => onChange(e.target.value)} className=" w-full bg-transparent py-6 outline-none " />
        </div>
    );
}
