                ...
                <div className="space-y-8">
                    ...
                    <div className="overflow-hidden rounded-[34px] border border-slate-200 bg-white">
                        <div className="border-b border-slate-100 px-8 py-6">
                            <h3 className="text-lg font-bold text-slate-900">آیتم‌های سفارش</h3>
                        </div>
                ...
                <div className="space-y-8">
                    ...
                    <Card>
                        ...
                        <div className="mt-8 space-y-4">
                            <StatusRow label="پرداخت" value="Completed" />

                            <StatusRow label="ارسال" value="Shipped" />

                            <StatusRow label="Tracking" value="TRK-982341" />
                        </div>
                    </Card>
                    ...
                    <Card>
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-xs text-slate-500">info@pars.com</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 space-y-4">
                            ...
                            <Row icon={<Clock3 size={15} />} value="Customer Since 2024" />
                        </div>
                    </Card>
...
function TimelineItem({ icon, title, time }: { icon: ReactNode; title: string; time: string }) {
    return (
        <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500">Order Event</p>
                </div>
            </div>
