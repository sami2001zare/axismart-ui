    ...
    return (
        <div className="space-y-8">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <div className="flex flex-wrap items-center gap-4">
                            <h1 className="text-4xl font-black text-slate-900">SUP-2041</h1>
                        ...
                        <p className="mt-3 text-sm text-slate-500">مشکل در ثبت سفارش عمده</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid gap-8 xl:grid-cols-[1.5fr_380px]">
                <div className="space-y-6">
                    ...
                    <div className="rounded-[34px] border border-slate-200 bg-white p-7">
                        <textarea
                            ...
                            className="w-full resize-none rounded-2xl border border-slate-200 bg-slate-50 p-5 text-sm outline-none"
                        />
                ...
                <div className="space-y-8">
                    <div className="rounded-[34px] border border-slate-200 bg-white p-7">
                        <h3 className="font-black text-slate-900">جزئیات تیکت</h3>

                        <div className="mt-8 space-y-4">
                            <Info label="شناسه" value="SUP-2041" />

                            <Info label="دپارتمان" value="فروش" />

                            <Info label="اولویت" value="High" />

                            <Info label="تاریخ" value="2026/05/31" />
                        </div>
                    </div>

                    <div className="rounded-[34px] border border-slate-200 bg-white p-7">
                        <h3 className="font-black text-slate-900">وضعیت</h3>

                        <div className="mt-8 space-y-5">
                            <StatusCard icon={<Clock3 size={18} />} title="در حال بررسی" />

                            <StatusCard icon={<CheckCircle2 size={18} />} title="پاسخ داده شد" />
...
function Message({
    ...
    return (
        <div className={`flex ${mine ? 'justify-end' : 'justify-start'} `}>
            <div
                className={`max-w-[720px] rounded-[34px] p-7 ${
            ...
            >
                ...
                <p
                    className={`mt-5 text-sm leading-8 ${mine ? 'text-blue-50' : 'text-slate-600'} `}
                >
                    {text}
                </p>
            </div>
