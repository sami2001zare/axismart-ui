...
import { Shield, KeyRound, Smartphone, Save, CheckCircle2 } from 'lucide-react';

export default function SecurityPage() {
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-4xl font-black text-slate-900">امنیت حساب</h1>

                <p className="mt-3 text-sm text-slate-500">تنظیمات امنیتی و مدیریت دسترسی حساب.</p>
            </div>
            ...
            <div className="grid gap-8 xl:grid-cols-[1fr_420px]">
                    ...
                    <div className="rounded-[34px] border border-slate-200 bg-white p-8">
                        ...
                        <div className="mt-8 rounded-3xl bg-slate-50 p-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-slate-900">Google Authenticator</p>
                ...
                <div className="space-y-8">
                    <div className="rounded-[34px] border border-slate-200 bg-gradient-to-br from-slate-900 to-blue-900 p-8 text-white">
                        ...
                        <h3 className="mt-8 text-2xl font-black">Security Score</h3>
                    ...
                    <div className="rounded-[34px] border border-slate-200 bg-white p-8">
                        ...
                        <div className="mt-8 space-y-5">
                            <Activity title="ورود موفق" time="امروز — تهران" />

                            <Activity title="تغییر رمز عبور" time="۲ روز پیش" />

                            <Activity title="فعال‌سازی 2FA" time="۱ هفته پیش" />
                        </div>
                    </div>
                </div>
            </div>
...
function Activity({ title, time }: { title: string; time: string }) {
    return (
