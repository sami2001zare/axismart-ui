...
import { LayoutDashboard, ShoppingBag, Heart, MapPin, User, Shield, Bell, Receipt, LogOut, Search, ChevronDown, MessageSquare, FileSpreadsheet } from "lucide-react";
        ...
        <div className=" min-h-screen bg-slate-50 ">
            ...
            <div className=" grid min-h-screen xl:grid-cols-[320px_1fr] ">
                ...
                <aside className=" border-l border-slate-200 bg-white p-6 ">
                    ...
                    <div className=" mt-16 rounded-[28px] bg-slate-900 p-6 text-white ">
                    ...
                    <button className=" mt-8 flex w-full items-center gap-4 rounded-2xl border border-slate-200 px-5 py-4 text-sm font-medium text-slate-700 ">
                        <LogOut size={16} />
                        خروج
                    </button>
                </aside>
...
function NavItem({
    ...
    return (
        <Link href={href} className=" flex items-center gap-4 rounded-2xl px-5 py-4 text-sm font-medium text-slate-700 transition hover:bg-blue-600 hover:text-white ">
            {icon}
            {label}
        </Link>
    );
