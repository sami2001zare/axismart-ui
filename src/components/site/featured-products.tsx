            ...
            <div className="relative mx-auto max-w-[1450px] px-8">
                ...
                <div className="mb-20 flex flex-col lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <h2 className="mt-8 max-w-[900px] text-5xl leading-[1.5] font-black text-slate-900">
                            انتخاب حرفه‌ای برای صنعت، تولید و پروژه‌های تخصصی
                        </h2>
                    </div>

                    <button className="mt-8 border border-slate-300 bg-white px-8 py-4 font-medium hover:border-blue-500 lg:mt-0">
                        مشاهده همه محصولات
                    </button>
                </div>
...
function PremiumShowcase() {
    return (
        <motion.div
            whileHover={{ y: -10 }}
            className="relative overflow-hidden border border-slate-200 bg-white p-12 shadow-[0_35px_80px_rgba(15,23,42,.06)] lg:col-span-7"
        >
            {/* Accent */}
            <div className="absolute top-0 left-0 h-full w-2 bg-gradient-to-b from-blue-600 to-cyan-500" />

            {/* Glow */}
            <div className="absolute top-0 -left-32 h-[300px] w-[300px] rounded-full bg-blue-100 blur-[90px]" />

            <div className="relative">
                <div className="flex items-center justify-between">
                    <span className="bg-emerald-100 px-4 py-2 text-sm text-emerald-700">
                        پرفروش‌ترین محصول
                    </span>
                    <span className="text-sm text-slate-400">AXM-2026</span>
                </div>

                <div className="mt-14 grid items-center gap-10 lg:grid-cols-2">
                    {/* LEFT */}
                    <div>
                        <h3 className="text-5xl leading-[1.4] font-black text-slate-900">
                            بلبرینگ صنعتی SKF
                        </h3>
                        ...
                        <div className="mt-14">
                            <p className="text-sm text-slate-400">شروع قیمت</p>
    ...
    return (
        ...
        >
            <div className="flex items-start justify-between">
                <div>
                    <span className="text-xs tracking-[3px] text-slate-400 uppercase">
                        {category}
                    </span>
            ...
            <div className="mt-10 flex items-center justify-between">
                <div>
                    ...
                    <h4 className="mt-2 text-2xl font-black text-blue-600">{price}</h4>
                </div>
