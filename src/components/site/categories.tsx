...
const categories = [
    {
        ...
        description:
            "بلبرینگ‌های صنعتی تخصصی برای ماشین‌آلات، خطوط تولید و تجهیزات سنگین.",
        icon: "⚙️",
        size: "large",
    ...
    },
    {
        ...
        description:
            "تسمه‌های انتقال قدرت با کیفیت بالا برای کاربردهای صنعتی.",
        icon: "🔗",
        size: "small",
    ...
    },
    {
        ...
        description:
            "سیستم‌های پولی مقاوم برای انتقال دقیق نیرو.",
        icon: "⭕",
        size: "small",
    ...
    },
    {
        ...
        description:
            "زنجیرهای صنعتی مقاوم برای خطوط تولید و تجهیزات سنگین.",
        icon: "⛓️",
        size: "wide",
